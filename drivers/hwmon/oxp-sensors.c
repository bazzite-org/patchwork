...
static u8 charge_type_values_x1[] = {
	[CT_OFF] = 0x00,
	[CT_AWAKE] = OXP_X1_CHARGE_BYPASS_MASK_AWAKE,
	[CT_ASLEEP] = OXP_X1_CHARGE_BYPASS_MASK_AWAKE | OXP_X1_CHARGE_BYPASS_MASK_SLEEP,
	[CT_ALWAYS] = OXP_X1_CHARGE_BYPASS_MASK_AWAKE | OXP_X1_CHARGE_BYPASS_MASK_SLEEP | OXP_X1_CHARGE_BYPASS_MASK_OFF,
};

static const char * const charge_type_strings[] = {
	[CT_OFF] = "Standard",
	[CT_AWAKE] = "BypassAwake",
	[CT_ASLEEP] = "BypassAsleep",
	[CT_ALWAYS] = "Bypass",
};
