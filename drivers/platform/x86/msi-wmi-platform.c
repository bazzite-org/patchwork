...
static SENSOR_DEVICE_ATTR_2_RW(pwm1_auto_point7_temp, msi_wmi_platform_temp_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_CPU_TEMP_TABLE, 0x1);
static SENSOR_DEVICE_ATTR_2_RW(pwm1_auto_point8_temp, msi_wmi_platform_temp_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_CPU_TEMP_TABLE, 0x2);

static SENSOR_DEVICE_ATTR_2_RW(pwm1_auto_point1_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_CPU_FAN_TABLE, 0x0);
...
static SENSOR_DEVICE_ATTR_2_RW(pwm1_auto_point7_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_GPU_FAN_TABLE, 0x6);
static SENSOR_DEVICE_ATTR_2_RW(pwm1_auto_point8_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_GPU_FAN_TABLE, 0x7);
...
static SENSOR_DEVICE_ATTR_2_RW(pwm2_auto_point7_temp, msi_wmi_platform_temp_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_CPU_TEMP_TABLE, 0x1);
static SENSOR_DEVICE_ATTR_2_RW(pwm2_auto_point8_temp, msi_wmi_platform_temp_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_CPU_TEMP_TABLE, 0x2);

static SENSOR_DEVICE_ATTR_2_RW(pwm2_auto_point1_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_GPU_FAN_TABLE, 0x0);
...
static SENSOR_DEVICE_ATTR_2_RW(pwm2_auto_point7_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_GPU_FAN_TABLE, 0x6);
static SENSOR_DEVICE_ATTR_2_RW(pwm2_auto_point8_pwm, msi_wmi_platform_fan_table,
			       MSI_PLATFORM_FAN_SUBFEATURE_GPU_FAN_TABLE, 0x7);
