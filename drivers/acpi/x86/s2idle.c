...
static int acpi_s2idle_lps0_entry(void)
{
	...
	if (delay_quirks && delay_quirks->delay_lps0_entry)
		msleep(delay_quirks->delay_lps0_entry);
...
static int acpi_s2idle_lps0_exit(void)
{
	...
	if (delay_quirks && delay_quirks->delay_lps0_exit)
		msleep(delay_quirks->delay_lps0_exit);
